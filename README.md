...
* Version 1.0 of the Microsoft implementation of the QUIC protocol [MSQUIC has been released](https://github.com/microsoft/msquic) ⭐ 4,781 | 🐛 342 | 🌐 C | 📅 2026-09-25
...
* Experimental QUIC codec for [netty](https://github.com/netty/netty-incubator-codec-quic) ⚠️ Archived makes use of [quiche](https://github.com/cloudflare/quiche) ⭐ 12,617 | 🐛 370 | 🌐 Rust | 📅 2026-09-25
...
* **OpenSource** [quiche](https://github.com/cloudflare/quiche/commit/75c62c1fe97578173b74f16717a7fe9f2d34d5b0) ⭐ 12,617 | 🐛 370 | 🌐 Rust | 📅 2026-09-25 landed supported for QUIC & HTTP/3 unreliable datagram into . It can help support low-latency where guaranteed delivery of data is not paramount.
...
| --------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------- | ------------------------------------------------ | ----------------------- |
| Microsoft's [MsQuic](https://github.com/microsoft/msquic) ⭐ 4,781 \| 🐛 342 \| 🌐 C \| 📅 2026-09-25                                          | draft-27/28/29/30/31/32                                       | client, server                                   | TLS 1.3 RFC             |
| Facebook's [mvfst](https://github.com/facebookincubator/mvfst) ⭐ 1,662 \| 🐛 37 \| 🌐 C++ \| 📅 2026-09-26                                    | draft-29                                                      | library, client, server                          | TLS 1.3                 |
...
| [ngtcp2](https://github.com/ngtcp2/ngtcp2) ⭐ 1,521 \| 🐛 19 \| 🌐 C \| 📅 2026-09-26                                                          | draft-29, draft-30, draft-31, and draft-32                    | library, client, server                          | TLSv1.3 (RFC 8446)      |
| Cloudflare's [nginx-cloudflare](https://github.com/cloudflare/quiche/tree/master/extras/nginx) ⭐ 12,617 \| 🐛 370 \| 🌐 Rust \| 📅 2026-09-25 | draft-27, draft-28, draft-29                                  | server                                           | TLSv1.3 (RFC8446)       |
| [picoquic](https://github.com/private-octopus/picoquic) ⭐ 776 \| 🐛 32 \| 🌐 C \| 📅 2026-09-25                                               | draft-32/31/30/29/28/27                                       | library and test tools, test client, test server | TLS 1.3 (using picotls) |
...
| [TQUIC](https://github.com/Tencent/tquic) ⭐ 1,438 \| 🐛 50 \| 🌐 Rust \| 📅 2025-12-23                                                        | v1                                                            | library, client, server                          | TLS 1.3                 |

### Rust

| Name                                                                                                       | Version                      | Roles                   | Handshake         |
| ---------------------------------------------------------------------------------------------------------- | ---------------------------- | ----------------------- | ----------------- |
| Cloudflare's [quiche](https://github.com/cloudflare/quiche) ⭐ 12,617 \| 🐛 370 \| 🌐 Rust \| 📅 2026-09-25 | draft-27, draft-28, draft-29 | library, client, server | TLSv1.3 (RFC8446) |
| Mozilla/Firefox's [Neqo](https://github.com/mozilla/neqo) ⭐ 2,244 \| 🐛 196 \| 🌐 Rust \| 📅 2026-09-25    | draft-30                     | library, client, server | TLS 1.3           |
| [Quinn](https://github.com/djc/quinn) ⭐ 5,271 \| 🐛 186 \| 🌐 Rust \| 📅 2026-09-23                        | draft-28                     | library, client, server | TLS 1.3           |
| [TQUIC](https://github.com/Tencent/tquic) ⭐ 1,438 \| 🐛 50 \| 🌐 Rust \| 📅 2025-12-23                     | v1                           | library, client, server | TLS 1.3           |
...
| Name                                                                                              | Version                  | Roles                   | Handshake   |
| ------------------------------------------------------------------------------------------------- | ------------------------ | ----------------------- | ----------- |
| [quic-go](https://github.com/lucas-clemente/quic-go) ⭐ 11,783 \| 🐛 214 \| 🌐 Go \| 📅 2026-09-22 | always the current draft | library, client, server | TLS 1.3 RFC |
...
| Name                                                                                        | Version  | Roles                   | Handshake |
| ------------------------------------------------------------------------------------------- | -------- | ----------------------- | --------- |
| [aioquic](https://github.com/aiortc/aioquic) ⭐ 2,006 \| 🐛 27 \| 🌐 Python \| 📅 2025-10-11 | draft-29 | library, client, server | TLS 1.3   |

### Haskell

| Name                                                                                               | Version  | Roles                   | Handshake |
| -------------------------------------------------------------------------------------------------- | -------- | ----------------------- | --------- |
| [Haskell quic](https://github.com/kazu-yamamoto/quic) ⭐ 119 \| 🐛 9 \| 🌐 Haskell \| 📅 2026-09-26 | draft-29 | library, client, server | TLS 1.3   |
