...
* Version 1.0 of the Microsoft implementation of the QUIC protocol [MSQUIC has been released](https://github.com/microsoft/msquic) ⭐ 4,770 | 🐛 331 | 🌐 C | 📅 2026-08-24
...
* [lsquic release 2.24.4](https://github.com/litespeedtech/lsquic) ⭐ 1,865 | 🐛 48 | 🌐 C | 📅 2026-08-02, contains fixes to congestion controller and to CID lifecycle.
...
| --------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------- | ------------------------------------------------ | ----------------------- |
| Microsoft's [MsQuic](https://github.com/microsoft/msquic) ⭐ 4,770 \| 🐛 331 \| 🌐 C \| 📅 2026-08-24                                          | draft-27/28/29/30/31/32                                       | client, server                                   | TLS 1.3 RFC             |
| Facebook's [mvfst](https://github.com/facebookincubator/mvfst) ⭐ 1,657 \| 🐛 36 \| 🌐 C++ \| 📅 2026-08-24                                    | draft-29                                                      | library, client, server                          | TLS 1.3                 |
...
| LiteSpeed's [lsquic](https://github.com/litespeedtech/lsquic) ⭐ 1,865 \| 🐛 48 \| 🌐 C \| 📅 2026-08-02                                       | Draft-32, Draft-29, Draft-28, Draft-27, Q043, Q046, and Q050. | library, client, server                          | QUIC Crypto, RFC 8446   |
| [ngtcp2](https://github.com/ngtcp2/ngtcp2) ⭐ 1,507 \| 🐛 22 \| 🌐 C \| 📅 2026-08-24                                                          | draft-29, draft-30, draft-31, and draft-32                    | library, client, server                          | TLSv1.3 (RFC 8446)      |
...
| [picoquic](https://github.com/private-octopus/picoquic) ⭐ 766 \| 🐛 35 \| 🌐 C \| 📅 2026-08-21                                               | draft-32/31/30/29/28/27                                       | library and test tools, test client, test server | TLS 1.3 (using picotls) |
...
| Mozilla/Firefox's [Neqo](https://github.com/mozilla/neqo) ⭐ 2,220 \| 🐛 162 \| 🌐 Rust \| 📅 2026-08-24    | draft-30                     | library, client, server | TLS 1.3           |
...
| Name                                                                                              | Version                  | Roles                   | Handshake   |
| ------------------------------------------------------------------------------------------------- | ------------------------ | ----------------------- | ----------- |
| [quic-go](https://github.com/lucas-clemente/quic-go) ⭐ 11,750 \| 🐛 223 \| 🌐 Go \| 📅 2026-08-24 | always the current draft | library, client, server | TLS 1.3 RFC |
...
| Name                                                                                        | Version  | Roles                   | Handshake |
| ------------------------------------------------------------------------------------------- | -------- | ----------------------- | --------- |
| [aioquic](https://github.com/aiortc/aioquic) ⭐ 2,001 \| 🐛 22 \| 🌐 Python \| 📅 2025-10-11 | draft-29 | library, client, server | TLS 1.3   |
