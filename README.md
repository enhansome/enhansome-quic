...
* Version 1.0 of the Microsoft implementation of the QUIC protocol [MSQUIC has been released](https://github.com/microsoft/msquic) ⭐ 4,780 | 🐛 349 | 🌐 C | 📅 2026-09-23
* [WebTransport Explainer](https://github.com/w3c/webtransport/blob/master/explainer.md) ⭐ 991 | 🐛 28 | 🌐 Bikeshed | 📅 2026-09-23
...
* Experimental QUIC codec for [netty](https://github.com/netty/netty-incubator-codec-quic) ⚠️ Archived makes use of [quiche](https://github.com/cloudflare/quiche) ⭐ 12,555 | 🐛 368 | 🌐 Rust | 📅 2026-09-21
...
* [lsquic release 2.24.4](https://github.com/litespeedtech/lsquic) ⭐ 1,875 | 🐛 49 | 🌐 C | 📅 2026-09-20, contains fixes to congestion controller and to CID lifecycle.
...
* **OpenSource** [quiche](https://github.com/cloudflare/quiche/commit/75c62c1fe97578173b74f16717a7fe9f2d34d5b0) ⭐ 12,555 | 🐛 368 | 🌐 Rust | 📅 2026-09-21 landed supported for QUIC & HTTP/3 unreliable datagram into . It can help support low-latency where guaranteed delivery of data is not paramount.
...
| --------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------- | ------------------------------------------------ | ----------------------- |
| Microsoft's [MsQuic](https://github.com/microsoft/msquic) ⭐ 4,780 \| 🐛 349 \| 🌐 C \| 📅 2026-09-23                                          | draft-27/28/29/30/31/32                                       | client, server                                   | TLS 1.3 RFC             |
...
| LiteSpeed's [lsquic](https://github.com/litespeedtech/lsquic) ⭐ 1,875 \| 🐛 49 \| 🌐 C \| 📅 2026-09-20                                       | Draft-32, Draft-29, Draft-28, Draft-27, Q043, Q046, and Q050. | library, client, server                          | QUIC Crypto, RFC 8446   |
| [ngtcp2](https://github.com/ngtcp2/ngtcp2) ⭐ 1,518 \| 🐛 19 \| 🌐 C \| 📅 2026-09-17                                                          | draft-29, draft-30, draft-31, and draft-32                    | library, client, server                          | TLSv1.3 (RFC 8446)      |
| Cloudflare's [nginx-cloudflare](https://github.com/cloudflare/quiche/tree/master/extras/nginx) ⭐ 12,555 \| 🐛 368 \| 🌐 Rust \| 📅 2026-09-21 | draft-27, draft-28, draft-29                                  | server                                           | TLSv1.3 (RFC8446)       |
| [picoquic](https://github.com/private-octopus/picoquic) ⭐ 776 \| 🐛 30 \| 🌐 C \| 📅 2026-09-24                                               | draft-32/31/30/29/28/27                                       | library and test tools, test client, test server | TLS 1.3 (using picotls) |
...
| Fastly's [quicly](https://github.com/h2o/quicly) ⭐ 663 \| 🐛 109 \| 🌐 C \| 📅 2026-09-24                                                     | draft-27                                                      | client, server                                   | TLS 1.3 (final)         |
...
| Name                                                                                                       | Version                      | Roles                   | Handshake         |
| ---------------------------------------------------------------------------------------------------------- | ---------------------------- | ----------------------- | ----------------- |
| Cloudflare's [quiche](https://github.com/cloudflare/quiche) ⭐ 12,555 \| 🐛 368 \| 🌐 Rust \| 📅 2026-09-21 | draft-27, draft-28, draft-29 | library, client, server | TLSv1.3 (RFC8446) |
| Mozilla/Firefox's [Neqo](https://github.com/mozilla/neqo) ⭐ 2,244 \| 🐛 197 \| 🌐 Rust \| 📅 2026-09-24    | draft-30                     | library, client, server | TLS 1.3           |
| [Quinn](https://github.com/djc/quinn) ⭐ 5,269 \| 🐛 187 \| 🌐 Rust \| 📅 2026-09-23                        | draft-28                     | library, client, server | TLS 1.3           |
| [TQUIC](https://github.com/Tencent/tquic) ⭐ 1,437 \| 🐛 50 \| 🌐 Rust \| 📅 2025-12-23                     | v1                           | library, client, server | TLS 1.3           |
...
| Name                                                                                              | Version                  | Roles                   | Handshake   |
| ------------------------------------------------------------------------------------------------- | ------------------------ | ----------------------- | ----------- |
| [quic-go](https://github.com/lucas-clemente/quic-go) ⭐ 11,778 \| 🐛 213 \| 🌐 Go \| 📅 2026-09-22 | always the current draft | library, client, server | TLS 1.3 RFC |
...
| Name                                                                                        | Version  | Roles                   | Handshake |
| ------------------------------------------------------------------------------------------- | -------- | ----------------------- | --------- |
| [aioquic](https://github.com/aiortc/aioquic) ⭐ 2,005 \| 🐛 26 \| 🌐 Python \| 📅 2025-10-11 | draft-29 | library, client, server | TLS 1.3   |

### Haskell

| Name                                                                                                | Version  | Roles                   | Handshake |
| --------------------------------------------------------------------------------------------------- | -------- | ----------------------- | --------- |
| [Haskell quic](https://github.com/kazu-yamamoto/quic) ⭐ 119 \| 🐛 10 \| 🌐 Haskell \| 📅 2026-09-24 | draft-29 | library, client, server | TLS 1.3   |
