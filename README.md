...
* Version 1.0 of the Microsoft implementation of the QUIC protocol [MSQUIC has been released](https://github.com/microsoft/msquic) ⭐ 4,760 | 🐛 324 | 🌐 C | 📅 2026-08-18
* [WebTransport Explainer](https://github.com/w3c/webtransport/blob/master/explainer.md) ⭐ 987 | 🐛 23 | 🌐 Bikeshed | 📅 2026-07-27
...
* Experimental QUIC codec for [netty](https://github.com/netty/netty-incubator-codec-quic) ⚠️ Archived makes use of [quiche](https://github.com/cloudflare/quiche) ⭐ 11,782 | 🐛 337 | 🌐 Rust | 📅 2026-08-14
...
* **OpenSource** [quiche](https://github.com/cloudflare/quiche/commit/75c62c1fe97578173b74f16717a7fe9f2d34d5b0) ⭐ 11,782 | 🐛 337 | 🌐 Rust | 📅 2026-08-14 landed supported for QUIC & HTTP/3 unreliable datagram into . It can help support low-latency where guaranteed delivery of data is not paramount.
...
| --------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------- | ------------------------------------------------ | ----------------------- |
| Microsoft's [MsQuic](https://github.com/microsoft/msquic) ⭐ 4,760 \| 🐛 324 \| 🌐 C \| 📅 2026-08-18                                          | draft-27/28/29/30/31/32                                       | client, server                                   | TLS 1.3 RFC             |
| Facebook's [mvfst](https://github.com/facebookincubator/mvfst) ⭐ 1,656 \| 🐛 36 \| 🌐 C++ \| 📅 2026-08-19                                    | draft-29                                                      | library, client, server                          | TLS 1.3                 |
...
| [ngtcp2](https://github.com/ngtcp2/ngtcp2) ⭐ 1,504 \| 🐛 23 \| 🌐 C \| 📅 2026-08-18                                                          | draft-29, draft-30, draft-31, and draft-32                    | library, client, server                          | TLSv1.3 (RFC 8446)      |
| Cloudflare's [nginx-cloudflare](https://github.com/cloudflare/quiche/tree/master/extras/nginx) ⭐ 11,782 \| 🐛 337 \| 🌐 Rust \| 📅 2026-08-14 | draft-27, draft-28, draft-29                                  | server                                           | TLSv1.3 (RFC8446)       |
| [picoquic](https://github.com/private-octopus/picoquic) ⭐ 765 \| 🐛 32 \| 🌐 C \| 📅 2026-08-18                                               | draft-32/31/30/29/28/27                                       | library and test tools, test client, test server | TLS 1.3 (using picotls) |
...
| Fastly's [quicly](https://github.com/h2o/quicly) ⭐ 663 \| 🐛 105 \| 🌐 C \| 📅 2026-08-17                                                     | draft-27                                                      | client, server                                   | TLS 1.3 (final)         |
| [nginx-quic](https://hg.nginx.org/nginx-quic/)                                                                                                | draft-27 .. draft-32                                          | server                                           | TLSv1.3 (RFC8446)       |
| [TQUIC](https://github.com/Tencent/tquic) ⭐ 1,426 \| 🐛 49 \| 🌐 Rust \| 📅 2025-12-23                                                        | v1                                                            | library, client, server                          | TLS 1.3                 |

### Rust

| Name                                                                                                       | Version                      | Roles                   | Handshake         |
| ---------------------------------------------------------------------------------------------------------- | ---------------------------- | ----------------------- | ----------------- |
| Cloudflare's [quiche](https://github.com/cloudflare/quiche) ⭐ 11,782 \| 🐛 337 \| 🌐 Rust \| 📅 2026-08-14 | draft-27, draft-28, draft-29 | library, client, server | TLSv1.3 (RFC8446) |
| Mozilla/Firefox's [Neqo](https://github.com/mozilla/neqo) ⭐ 2,215 \| 🐛 171 \| 🌐 Rust \| 📅 2026-08-18    | draft-30                     | library, client, server | TLS 1.3           |
| [Quinn](https://github.com/djc/quinn) ⭐ 5,222 \| 🐛 196 \| 🌐 Rust \| 📅 2026-08-18                        | draft-28                     | library, client, server | TLS 1.3           |
| [TQUIC](https://github.com/Tencent/tquic) ⭐ 1,426 \| 🐛 49 \| 🌐 Rust \| 📅 2025-12-23                     | v1                           | library, client, server | TLS 1.3           |
...
| Name                                                                                              | Version                  | Roles                   | Handshake   |
| ------------------------------------------------------------------------------------------------- | ------------------------ | ----------------------- | ----------- |
| [quic-go](https://github.com/lucas-clemente/quic-go) ⭐ 11,741 \| 🐛 217 \| 🌐 Go \| 📅 2026-08-16 | always the current draft | library, client, server | TLS 1.3 RFC |
...
| Name                                                                                        | Version  | Roles                   | Handshake |
| ------------------------------------------------------------------------------------------- | -------- | ----------------------- | --------- |
| [aioquic](https://github.com/aiortc/aioquic) ⭐ 1,998 \| 🐛 20 \| 🌐 Python \| 📅 2025-10-11 | draft-29 | library, client, server | TLS 1.3   |
